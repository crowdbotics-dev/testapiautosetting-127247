...
## Project Structure
    ...
    ├── testapiautosetting_127247  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127247`
...
2. Clone this repo and `cd testapiautosetting_127247`
